...
| 탭 | 내용 |
|---|---|
| 오늘 | 명언 · 일일 루틴 5개 · **배울 표현**(아직 학습 체크 안 한 것) |
| 복습 | 망각 곡선 설명 · 오늘 복습 큐 · 단계별 현황 |
| 표현 | 전체 목록 + 검색 + 필터 6종 + 직접 추가 |
| 기록 | 달력 · 누적 통계 · 설정(효과음, 말하기 속도) |
...
```
뜻 → 예문(리듬) → 이럴 때 → 덩어리로 외우기 → 내 문장 → 진도 → 액션
```
...
- **내 문장**(`myLine`): 모든 카드에 있는 유일한 공통 입력. 카드 종류가 달라도 행동은 같게 만드는 장치.
